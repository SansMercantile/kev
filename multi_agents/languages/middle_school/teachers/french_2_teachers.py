"""
French2Teacher - Languages French_2 Teacher
...
class French2Teacher(BaseTutorAgent):
    """Teacher for French 2"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_middle_school_french_2_teachers_001",
            subject="Languages",
