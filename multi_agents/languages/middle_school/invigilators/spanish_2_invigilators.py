"""
Spanish2Invigilator - Languages Spanish_2 Invigilator
...
class Spanish2Invigilator(BaseTutorAgent):
    """Invigilator for Spanish 2"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_middle_school_spanish_2_invigilators_001",
            subject="Languages",
