"""
Mandarin2Invigilator - Languages Mandarin_2 Invigilator
...
class Mandarin2Invigilator(BaseTutorAgent):
    """Invigilator for Mandarin 2"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_middle_school_mandarin_2_invigilators_001",
            subject="Languages",
