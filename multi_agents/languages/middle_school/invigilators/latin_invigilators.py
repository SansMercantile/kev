"""
LatinInvigilator - Languages Latin Invigilator
...
class LatinInvigilator(BaseTutorAgent):
    """Invigilator for Latin"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_middle_school_latin_invigilators_001",
            subject="Languages",
