"""
Spanish2Expert - Languages Spanish_2 Expert
...
class Spanish2Expert(BaseTutorAgent):
    """Expert for Spanish 2"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_middle_school_spanish_2_experts_001",
            subject="Languages",
