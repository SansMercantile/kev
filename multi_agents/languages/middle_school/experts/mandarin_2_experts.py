"""
Mandarin2Expert - Languages Mandarin_2 Expert
...
class Mandarin2Expert(BaseTutorAgent):
    """Expert for Mandarin 2"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_middle_school_mandarin_2_experts_001",
            subject="Languages",
