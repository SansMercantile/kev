"""
Spanish2Mentor - Languages Spanish_2 Mentor
...
class Spanish2Mentor(BaseTutorAgent):
    """Mentor for Spanish 2"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_middle_school_spanish_2_mentors_001",
            subject="Languages",
