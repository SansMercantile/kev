"""
Mandarin2Mentor - Languages Mandarin_2 Mentor
...
class Mandarin2Mentor(BaseTutorAgent):
    """Mentor for Mandarin 2"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_middle_school_mandarin_2_mentors_001",
            subject="Languages",
