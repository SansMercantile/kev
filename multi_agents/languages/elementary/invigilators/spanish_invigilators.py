"""
SpanishInvigilator - Languages Spanish Invigilator
...
class SpanishInvigilator(BaseTutorAgent):
    """Invigilator for Spanish"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_elementary_spanish_invigilators_001",
            subject="Languages",
