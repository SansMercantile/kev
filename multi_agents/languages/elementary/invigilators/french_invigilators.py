"""
FrenchInvigilator - Languages French Invigilator
...
class FrenchInvigilator(BaseTutorAgent):
    """Invigilator for French"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_elementary_french_invigilators_001",
            subject="Languages",
