"""
ApSpanishExpert - Languages Ap_Spanish Expert
...
class ApSpanishExpert(BaseTutorAgent):
    """Expert for Ap Spanish"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_high_school_ap_spanish_experts_001",
            subject="Languages",
