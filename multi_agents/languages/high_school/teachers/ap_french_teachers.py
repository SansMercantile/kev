"""
ApFrenchTeacher - Languages Ap_French Teacher
...
class ApFrenchTeacher(BaseTutorAgent):
    """Teacher for Ap French"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_high_school_ap_french_teachers_001",
            subject="Languages",
