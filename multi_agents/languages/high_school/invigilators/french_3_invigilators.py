"""
French3Invigilator - Languages French_3 Invigilator
...
class French3Invigilator(BaseTutorAgent):
    """Invigilator for French 3"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_high_school_french_3_invigilators_001",
            subject="Languages",
