"""
Spanish3Invigilator - Languages Spanish_3 Invigilator
...
class Spanish3Invigilator(BaseTutorAgent):
    """Invigilator for Spanish 3"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_high_school_spanish_3_invigilators_001",
            subject="Languages",
