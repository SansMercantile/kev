"""
ApSpanishInvigilator - Languages Ap_Spanish Invigilator
...
class ApSpanishInvigilator(BaseTutorAgent):
    """Invigilator for Ap Spanish"""
    
    def __init__(self):
        super().__init__(
            tutor_id="languages_high_school_ap_spanish_invigilators_001",
            subject="Languages",
