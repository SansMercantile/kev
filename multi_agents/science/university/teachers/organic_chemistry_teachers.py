"""
OrganicChemistryTeacher - Science Organic_Chemistry Teacher
...
class OrganicChemistryTeacher(BaseTutorAgent):
    """Teacher for Organic Chemistry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_university_organic_chemistry_teachers_001",
            subject="Science",
