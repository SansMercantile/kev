"""
QuantumPhysicsMentor - Science Quantum_Physics Mentor
...
class QuantumPhysicsMentor(BaseTutorAgent):
    """Mentor for Quantum Physics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_university_quantum_physics_mentors_001",
            subject="Science",
