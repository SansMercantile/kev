"""
OrganicChemistryExpert - Science Organic_Chemistry Expert
...
class OrganicChemistryExpert(BaseTutorAgent):
    """Expert for Organic Chemistry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_university_organic_chemistry_experts_001",
            subject="Science",
