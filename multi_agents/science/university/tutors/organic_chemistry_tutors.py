"""
OrganicChemistryTutor - Science Organic_Chemistry Tutor
...
class OrganicChemistryTutor(BaseTutorAgent):
    """Tutor for Organic Chemistry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_university_organic_chemistry_tutors_001",
            subject="Science",
