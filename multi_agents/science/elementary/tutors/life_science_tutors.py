"""
LifeScienceTutor - Science Life_Science Tutor
...
class LifeScienceTutor(BaseTutorAgent):
    """Tutor for Life Science"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_elementary_life_science_tutors_001",
            subject="Science",
