"""
PhysicalScienceTutor - Science Physical_Science Tutor
...
class PhysicalScienceTutor(BaseTutorAgent):
    """Tutor for Physical Science"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_elementary_physical_science_tutors_001",
            subject="Science",
