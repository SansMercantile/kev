"""
PhysicalScienceTeacher - Science Physical_Science Teacher
...
class PhysicalScienceTeacher(BaseTutorAgent):
    """Teacher for Physical Science"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_elementary_physical_science_teachers_001",
            subject="Science",
