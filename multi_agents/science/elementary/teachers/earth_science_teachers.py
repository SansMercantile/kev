"""
EarthScienceTeacher - Science Earth_Science Teacher
...
class EarthScienceTeacher(BaseTutorAgent):
    """Teacher for Earth Science"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_elementary_earth_science_teachers_001",
            subject="Science",
