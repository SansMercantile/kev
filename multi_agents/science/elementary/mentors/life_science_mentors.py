"""
LifeScienceMentor - Science Life_Science Mentor
...
class LifeScienceMentor(BaseTutorAgent):
    """Mentor for Life Science"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_elementary_life_science_mentors_001",
            subject="Science",
