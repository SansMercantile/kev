"""
PhysicalScienceMentor - Science Physical_Science Mentor
...
class PhysicalScienceMentor(BaseTutorAgent):
    """Mentor for Physical Science"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_elementary_physical_science_mentors_001",
            subject="Science",
