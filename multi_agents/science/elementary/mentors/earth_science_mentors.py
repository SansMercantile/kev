"""
EarthScienceMentor - Science Earth_Science Mentor
...
class EarthScienceMentor(BaseTutorAgent):
    """Mentor for Earth Science"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_elementary_earth_science_mentors_001",
            subject="Science",
