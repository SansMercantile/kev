"""
EarthScienceInvigilator - Science Earth_Science Invigilator
...
class EarthScienceInvigilator(BaseTutorAgent):
    """Invigilator for Earth Science"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_elementary_earth_science_invigilators_001",
            subject="Science",
