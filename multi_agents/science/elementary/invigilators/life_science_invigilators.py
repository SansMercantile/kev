"""
LifeScienceInvigilator - Science Life_Science Invigilator
...
class LifeScienceInvigilator(BaseTutorAgent):
    """Invigilator for Life Science"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_elementary_life_science_invigilators_001",
            subject="Science",
