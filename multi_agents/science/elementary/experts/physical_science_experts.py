"""
PhysicalScienceExpert - Science Physical_Science Expert
...
class PhysicalScienceExpert(BaseTutorAgent):
    """Expert for Physical Science"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_elementary_physical_science_experts_001",
            subject="Science",
