"""
EarthScienceExpert - Science Earth_Science Expert
...
class EarthScienceExpert(BaseTutorAgent):
    """Expert for Earth Science"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_elementary_earth_science_experts_001",
            subject="Science",
