"""
LifeScienceExpert - Science Life_Science Expert
...
class LifeScienceExpert(BaseTutorAgent):
    """Expert for Life Science"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_elementary_life_science_experts_001",
            subject="Science",
