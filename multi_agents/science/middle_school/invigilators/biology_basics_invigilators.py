"""
BiologyBasicsInvigilator - Science Biology_Basics Invigilator
...
class BiologyBasicsInvigilator(BaseTutorAgent):
    """Invigilator for Biology Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_middle_school_biology_basics_invigilators_001",
            subject="Science",
