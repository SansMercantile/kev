"""
ChemistryBasicsInvigilator - Science Chemistry_Basics Invigilator
...
class ChemistryBasicsInvigilator(BaseTutorAgent):
    """Invigilator for Chemistry Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_middle_school_chemistry_basics_invigilators_001",
            subject="Science",
