"""
PhysicsBasicsInvigilator - Science Physics_Basics Invigilator
...
class PhysicsBasicsInvigilator(BaseTutorAgent):
    """Invigilator for Physics Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_middle_school_physics_basics_invigilators_001",
            subject="Science",
