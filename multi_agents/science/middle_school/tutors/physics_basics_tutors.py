"""
PhysicsBasicsTutor - Science Physics_Basics Tutor
...
class PhysicsBasicsTutor(BaseTutorAgent):
    """Tutor for Physics Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_middle_school_physics_basics_tutors_001",
            subject="Science",
