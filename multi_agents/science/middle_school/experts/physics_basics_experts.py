"""
PhysicsBasicsExpert - Science Physics_Basics Expert
...
class PhysicsBasicsExpert(BaseTutorAgent):
    """Expert for Physics Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_middle_school_physics_basics_experts_001",
            subject="Science",
