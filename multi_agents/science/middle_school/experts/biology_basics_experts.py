"""
BiologyBasicsExpert - Science Biology_Basics Expert
...
class BiologyBasicsExpert(BaseTutorAgent):
    """Expert for Biology Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_middle_school_biology_basics_experts_001",
            subject="Science",
