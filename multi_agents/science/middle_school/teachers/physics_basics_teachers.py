"""
PhysicsBasicsTeacher - Science Physics_Basics Teacher
...
class PhysicsBasicsTeacher(BaseTutorAgent):
    """Teacher for Physics Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_middle_school_physics_basics_teachers_001",
            subject="Science",
