"""
BiologyBasicsTeacher - Science Biology_Basics Teacher
...
class BiologyBasicsTeacher(BaseTutorAgent):
    """Teacher for Biology Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_middle_school_biology_basics_teachers_001",
            subject="Science",
