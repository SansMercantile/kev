"""
ChemistryBasicsTeacher - Science Chemistry_Basics Teacher
...
class ChemistryBasicsTeacher(BaseTutorAgent):
    """Teacher for Chemistry Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_middle_school_chemistry_basics_teachers_001",
            subject="Science",
