"""
BiologyBasicsMentor - Science Biology_Basics Mentor
...
class BiologyBasicsMentor(BaseTutorAgent):
    """Mentor for Biology Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_middle_school_biology_basics_mentors_001",
            subject="Science",
