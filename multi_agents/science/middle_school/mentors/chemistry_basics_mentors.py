"""
ChemistryBasicsMentor - Science Chemistry_Basics Mentor
...
class ChemistryBasicsMentor(BaseTutorAgent):
    """Mentor for Chemistry Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_middle_school_chemistry_basics_mentors_001",
            subject="Science",
