"""
PhysicsInvigilator - Science Physics Invigilator
...
class PhysicsInvigilator(BaseTutorAgent):
    """Invigilator for Physics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="science_high_school_physics_invigilators_001",
            subject="Science",
