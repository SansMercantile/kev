"""
AutomotiveInvigilator - Vocational Automotive Invigilator
...
class AutomotiveInvigilator(BaseTutorAgent):
    """Invigilator for Automotive"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_high_school_automotive_invigilators_001",
            subject="Vocational",
