"""
ElectricalInvigilator - Vocational Electrical Invigilator
...
class ElectricalInvigilator(BaseTutorAgent):
    """Invigilator for Electrical"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_high_school_electrical_invigilators_001",
            subject="Vocational",
