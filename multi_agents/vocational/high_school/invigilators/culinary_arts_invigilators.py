"""
CulinaryArtsInvigilator - Vocational Culinary_Arts Invigilator
...
class CulinaryArtsInvigilator(BaseTutorAgent):
    """Invigilator for Culinary Arts"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_high_school_culinary_arts_invigilators_001",
            subject="Vocational",
