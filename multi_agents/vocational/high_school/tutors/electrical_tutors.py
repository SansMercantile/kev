"""
ElectricalTutor - Vocational Electrical Tutor
...
class ElectricalTutor(BaseTutorAgent):
    """Tutor for Electrical"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_high_school_electrical_tutors_001",
            subject="Vocational",
