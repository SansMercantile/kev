"""
AutomotiveTutor - Vocational Automotive Tutor
...
class AutomotiveTutor(BaseTutorAgent):
    """Tutor for Automotive"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_high_school_automotive_tutors_001",
            subject="Vocational",
