"""
AutomotiveMentor - Vocational Automotive Mentor
...
class AutomotiveMentor(BaseTutorAgent):
    """Mentor for Automotive"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_high_school_automotive_mentors_001",
            subject="Vocational",
