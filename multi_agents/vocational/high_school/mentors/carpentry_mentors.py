"""
CarpentryMentor - Vocational Carpentry Mentor
...
class CarpentryMentor(BaseTutorAgent):
    """Mentor for Carpentry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_high_school_carpentry_mentors_001",
            subject="Vocational",
