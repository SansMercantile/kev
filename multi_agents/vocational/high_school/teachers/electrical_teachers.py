"""
ElectricalTeacher - Vocational Electrical Teacher
...
class ElectricalTeacher(BaseTutorAgent):
    """Teacher for Electrical"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_high_school_electrical_teachers_001",
            subject="Vocational",
