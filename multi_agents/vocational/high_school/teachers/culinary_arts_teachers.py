"""
CulinaryArtsTeacher - Vocational Culinary_Arts Teacher
...
class CulinaryArtsTeacher(BaseTutorAgent):
    """Teacher for Culinary Arts"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_high_school_culinary_arts_teachers_001",
            subject="Vocational",
