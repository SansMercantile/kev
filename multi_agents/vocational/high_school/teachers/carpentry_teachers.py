"""
CarpentryTeacher - Vocational Carpentry Teacher
...
class CarpentryTeacher(BaseTutorAgent):
    """Teacher for Carpentry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_high_school_carpentry_teachers_001",
            subject="Vocational",
