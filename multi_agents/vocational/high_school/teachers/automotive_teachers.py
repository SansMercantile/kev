"""
AutomotiveTeacher - Vocational Automotive Teacher
...
class AutomotiveTeacher(BaseTutorAgent):
    """Teacher for Automotive"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_high_school_automotive_teachers_001",
            subject="Vocational",
