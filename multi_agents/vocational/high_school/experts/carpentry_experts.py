"""
CarpentryExpert - Vocational Carpentry Expert
...
class CarpentryExpert(BaseTutorAgent):
    """Expert for Carpentry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_high_school_carpentry_experts_001",
            subject="Vocational",
