"""
ExecutiveChefInvigilator - Vocational Executive_Chef Invigilator
...
class ExecutiveChefInvigilator(BaseTutorAgent):
    """Invigilator for Executive Chef"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_professional_executive_chef_invigilators_001",
            subject="Vocational",
