"""
MasterCarpentryInvigilator - Vocational Master_Carpentry Invigilator
...
class MasterCarpentryInvigilator(BaseTutorAgent):
    """Invigilator for Master Carpentry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_professional_master_carpentry_invigilators_001",
            subject="Vocational",
