"""
MasterAutomotiveInvigilator - Vocational Master_Automotive Invigilator
...
class MasterAutomotiveInvigilator(BaseTutorAgent):
    """Invigilator for Master Automotive"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_professional_master_automotive_invigilators_001",
            subject="Vocational",
