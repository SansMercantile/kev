"""
MasterAutomotiveTeacher - Vocational Master_Automotive Teacher
...
class MasterAutomotiveTeacher(BaseTutorAgent):
    """Teacher for Master Automotive"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_professional_master_automotive_teachers_001",
            subject="Vocational",
