"""
MasterAutomotiveTutor - Vocational Master_Automotive Tutor
...
class MasterAutomotiveTutor(BaseTutorAgent):
    """Tutor for Master Automotive"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_professional_master_automotive_tutors_001",
            subject="Vocational",
