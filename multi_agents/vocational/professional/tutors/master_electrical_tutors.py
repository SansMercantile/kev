"""
MasterElectricalTutor - Vocational Master_Electrical Tutor
...
class MasterElectricalTutor(BaseTutorAgent):
    """Tutor for Master Electrical"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_professional_master_electrical_tutors_001",
            subject="Vocational",
