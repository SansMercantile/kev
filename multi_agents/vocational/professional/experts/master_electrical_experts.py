"""
MasterElectricalExpert - Vocational Master_Electrical Expert
...
class MasterElectricalExpert(BaseTutorAgent):
    """Expert for Master Electrical"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_professional_master_electrical_experts_001",
            subject="Vocational",
