"""
MasterAutomotiveExpert - Vocational Master_Automotive Expert
...
class MasterAutomotiveExpert(BaseTutorAgent):
    """Expert for Master Automotive"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_professional_master_automotive_experts_001",
            subject="Vocational",
