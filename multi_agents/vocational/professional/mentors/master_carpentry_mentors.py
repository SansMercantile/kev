"""
MasterCarpentryMentor - Vocational Master_Carpentry Mentor
...
class MasterCarpentryMentor(BaseTutorAgent):
    """Mentor for Master Carpentry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_professional_master_carpentry_mentors_001",
            subject="Vocational",
