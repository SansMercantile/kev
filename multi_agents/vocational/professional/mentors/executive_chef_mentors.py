"""
ExecutiveChefMentor - Vocational Executive_Chef Mentor
...
class ExecutiveChefMentor(BaseTutorAgent):
    """Mentor for Executive Chef"""
    
    def __init__(self):
        super().__init__(
            tutor_id="vocational_professional_executive_chef_mentors_001",
            subject="Vocational",
