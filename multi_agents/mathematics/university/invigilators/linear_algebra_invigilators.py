"""
LinearAlgebraInvigilator - Mathematics Linear_Algebra Invigilator
...
class LinearAlgebraInvigilator(BaseTutorAgent):
    """Invigilator for Linear Algebra"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_university_linear_algebra_invigilators_001",
            subject="Mathematics",
