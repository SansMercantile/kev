"""
LinearAlgebraTeacher - Mathematics Linear_Algebra Teacher
...
class LinearAlgebraTeacher(BaseTutorAgent):
    """Teacher for Linear Algebra"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_university_linear_algebra_teachers_001",
            subject="Mathematics",
