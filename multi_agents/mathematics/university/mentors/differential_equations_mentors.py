"""
DifferentialEquationsMentor - Mathematics Differential_Equations Mentor
...
class DifferentialEquationsMentor(BaseTutorAgent):
    """Mentor for Differential Equations"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_university_differential_equations_mentors_001",
            subject="Mathematics",
