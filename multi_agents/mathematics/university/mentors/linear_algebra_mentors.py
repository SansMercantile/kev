"""
LinearAlgebraMentor - Mathematics Linear_Algebra Mentor
...
class LinearAlgebraMentor(BaseTutorAgent):
    """Mentor for Linear Algebra"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_university_linear_algebra_mentors_001",
            subject="Mathematics",
