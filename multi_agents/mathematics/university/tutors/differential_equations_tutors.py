"""
DifferentialEquationsTutor - Mathematics Differential_Equations Tutor
...
class DifferentialEquationsTutor(BaseTutorAgent):
    """Tutor for Differential Equations"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_university_differential_equations_tutors_001",
            subject="Mathematics",
