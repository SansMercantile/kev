"""
Algebra2Expert - Mathematics Algebra_2 Expert
...
class Algebra2Expert(BaseTutorAgent):
    """Expert for Algebra 2"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_high_school_algebra_2_experts_001",
            subject="Mathematics",
