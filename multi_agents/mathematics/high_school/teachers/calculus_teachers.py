"""
CalculusTeacher - Mathematics Calculus Teacher
...
class CalculusTeacher(BaseTutorAgent):
    """Teacher for Calculus"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_high_school_calculus_teachers_001",
            subject="Mathematics",
