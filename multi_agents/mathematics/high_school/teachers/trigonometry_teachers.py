"""
TrigonometryTeacher - Mathematics Trigonometry Teacher
...
class TrigonometryTeacher(BaseTutorAgent):
    """Teacher for Trigonometry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_high_school_trigonometry_teachers_001",
            subject="Mathematics",
