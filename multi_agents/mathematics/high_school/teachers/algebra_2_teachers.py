"""
Algebra2Teacher - Mathematics Algebra_2 Teacher
...
class Algebra2Teacher(BaseTutorAgent):
    """Teacher for Algebra 2"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_high_school_algebra_2_teachers_001",
            subject="Mathematics",
