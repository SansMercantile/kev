"""
Algebra2Invigilator - Mathematics Algebra_2 Invigilator
...
class Algebra2Invigilator(BaseTutorAgent):
    """Invigilator for Algebra 2"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_high_school_algebra_2_invigilators_001",
            subject="Mathematics",
