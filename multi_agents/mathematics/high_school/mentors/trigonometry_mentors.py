"""
TrigonometryMentor - Mathematics Trigonometry Mentor
...
class TrigonometryMentor(BaseTutorAgent):
    """Mentor for Trigonometry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_high_school_trigonometry_mentors_001",
            subject="Mathematics",
