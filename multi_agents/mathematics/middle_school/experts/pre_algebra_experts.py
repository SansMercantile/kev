"""
PreAlgebraExpert - Mathematics Pre_Algebra Expert
...
class PreAlgebraExpert(BaseTutorAgent):
    """Expert for Pre Algebra"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_middle_school_pre_algebra_experts_001",
            subject="Mathematics",
