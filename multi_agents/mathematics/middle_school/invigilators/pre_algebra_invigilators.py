"""
PreAlgebraInvigilator - Mathematics Pre_Algebra Invigilator
...
class PreAlgebraInvigilator(BaseTutorAgent):
    """Invigilator for Pre Algebra"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_middle_school_pre_algebra_invigilators_001",
            subject="Mathematics",
