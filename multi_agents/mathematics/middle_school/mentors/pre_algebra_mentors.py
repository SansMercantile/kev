"""
PreAlgebraMentor - Mathematics Pre_Algebra Mentor
...
class PreAlgebraMentor(BaseTutorAgent):
    """Mentor for Pre Algebra"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_middle_school_pre_algebra_mentors_001",
            subject="Mathematics",
