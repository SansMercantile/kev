"""
PreAlgebraTutor - Mathematics Pre_Algebra Tutor
...
class PreAlgebraTutor(BaseTutorAgent):
    """Tutor for Pre Algebra"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_middle_school_pre_algebra_tutors_001",
            subject="Mathematics",
