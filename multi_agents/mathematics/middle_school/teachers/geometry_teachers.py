"""
GeometryTeacher - Mathematics Geometry Teacher
...
class GeometryTeacher(BaseTutorAgent):
    """Teacher for Geometry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_middle_school_geometry_teachers_001",
            subject="Mathematics",
