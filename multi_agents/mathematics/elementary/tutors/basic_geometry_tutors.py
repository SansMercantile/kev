"""
BasicGeometryTutor - Mathematics Basic_Geometry Tutor
...
class BasicGeometryTutor(BaseTutorAgent):
    """Tutor for Basic Geometry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_elementary_basic_geometry_tutors_001",
            subject="Mathematics",
