"""
ArithmeticInvigilator - Mathematics Arithmetic Invigilator
...
class ArithmeticInvigilator(BaseTutorAgent):
    """Invigilator for Arithmetic"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_elementary_arithmetic_invigilators_001",
            subject="Mathematics",
