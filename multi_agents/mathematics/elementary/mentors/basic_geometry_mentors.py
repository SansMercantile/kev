"""
BasicGeometryMentor - Mathematics Basic_Geometry Mentor
...
class BasicGeometryMentor(BaseTutorAgent):
    """Mentor for Basic Geometry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_elementary_basic_geometry_mentors_001",
            subject="Mathematics",
