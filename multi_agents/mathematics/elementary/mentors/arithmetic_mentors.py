"""
ArithmeticMentor - Mathematics Arithmetic Mentor
...
class ArithmeticMentor(BaseTutorAgent):
    """Mentor for Arithmetic"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_elementary_arithmetic_mentors_001",
            subject="Mathematics",
