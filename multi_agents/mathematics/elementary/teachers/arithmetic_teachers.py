"""
ArithmeticTeacher - Mathematics Arithmetic Teacher
...
class ArithmeticTeacher(BaseTutorAgent):
    """Teacher for Arithmetic"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_elementary_arithmetic_teachers_001",
            subject="Mathematics",
