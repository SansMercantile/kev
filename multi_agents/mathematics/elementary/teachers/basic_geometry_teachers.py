"""
BasicGeometryTeacher - Mathematics Basic_Geometry Teacher
...
class BasicGeometryTeacher(BaseTutorAgent):
    """Teacher for Basic Geometry"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_elementary_basic_geometry_teachers_001",
            subject="Mathematics",
