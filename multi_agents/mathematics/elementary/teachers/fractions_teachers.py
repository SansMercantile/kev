"""
FractionsTeacher - Mathematics Fractions Teacher
...
class FractionsTeacher(BaseTutorAgent):
    """Teacher for Fractions"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_elementary_fractions_teachers_001",
            subject="Mathematics",
