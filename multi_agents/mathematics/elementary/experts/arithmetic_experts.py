"""
ArithmeticExpert - Mathematics Arithmetic Expert
...
class ArithmeticExpert(BaseTutorAgent):
    """Expert for Arithmetic"""
    
    def __init__(self):
        super().__init__(
            tutor_id="mathematics_elementary_arithmetic_experts_001",
            subject="Mathematics",
