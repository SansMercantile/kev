"""
AdvancedFitnessMentor - Physical_Education Advanced_Fitness Mentor
...
class AdvancedFitnessMentor(BaseTutorAgent):
    """Mentor for Advanced Fitness"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_middle_school_advanced_fitness_mentors_001",
