"""
AdvancedFitnessTutor - Physical_Education Advanced_Fitness Tutor
...
class AdvancedFitnessTutor(BaseTutorAgent):
    """Tutor for Advanced Fitness"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_middle_school_advanced_fitness_tutors_001",
