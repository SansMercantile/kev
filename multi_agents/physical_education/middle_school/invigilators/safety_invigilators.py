"""
SafetyInvigilator - Physical_Education Safety Invigilator
...
class SafetyInvigilator(BaseTutorAgent):
    """Invigilator for Safety"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_middle_school_safety_invigilators_001",
