"""
AdvancedFitnessInvigilator - Physical_Education Advanced_Fitness Invigilator
...
class AdvancedFitnessInvigilator(BaseTutorAgent):
    """Invigilator for Advanced Fitness"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_middle_school_advanced_fitness_invigilators_001",
