"""
AdvancedFitnessExpert - Physical_Education Advanced_Fitness Expert
...
class AdvancedFitnessExpert(BaseTutorAgent):
    """Expert for Advanced Fitness"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_middle_school_advanced_fitness_experts_001",
