"""
IndividualSportsTeacher - Physical_Education Individual_Sports Teacher
...
class IndividualSportsTeacher(BaseTutorAgent):
    """Teacher for Individual Sports"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_elementary_individual_sports_teachers_001",
