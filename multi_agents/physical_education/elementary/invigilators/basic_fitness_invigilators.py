"""
BasicFitnessInvigilator - Physical_Education Basic_Fitness Invigilator
...
class BasicFitnessInvigilator(BaseTutorAgent):
    """Invigilator for Basic Fitness"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_elementary_basic_fitness_invigilators_001",
