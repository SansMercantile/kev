"""
IndividualSportsMentor - Physical_Education Individual_Sports Mentor
...
class IndividualSportsMentor(BaseTutorAgent):
    """Mentor for Individual Sports"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_elementary_individual_sports_mentors_001",
