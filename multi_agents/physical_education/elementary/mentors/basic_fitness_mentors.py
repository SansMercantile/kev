"""
BasicFitnessMentor - Physical_Education Basic_Fitness Mentor
...
class BasicFitnessMentor(BaseTutorAgent):
    """Mentor for Basic Fitness"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_elementary_basic_fitness_mentors_001",
