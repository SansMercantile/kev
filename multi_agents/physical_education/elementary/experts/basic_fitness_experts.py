"""
BasicFitnessExpert - Physical_Education Basic_Fitness Expert
...
class BasicFitnessExpert(BaseTutorAgent):
    """Expert for Basic Fitness"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_elementary_basic_fitness_experts_001",
