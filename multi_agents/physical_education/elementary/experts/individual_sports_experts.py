"""
IndividualSportsExpert - Physical_Education Individual_Sports Expert
...
class IndividualSportsExpert(BaseTutorAgent):
    """Expert for Individual Sports"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_elementary_individual_sports_experts_001",
