"""
HealthEducationExpert - Physical_Education Health_Education Expert
...
class HealthEducationExpert(BaseTutorAgent):
    """Expert for Health Education"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_high_school_health_education_experts_001",
