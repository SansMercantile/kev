"""
PersonalFitnessExpert - Physical_Education Personal_Fitness Expert
...
class PersonalFitnessExpert(BaseTutorAgent):
    """Expert for Personal Fitness"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_high_school_personal_fitness_experts_001",
