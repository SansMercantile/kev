"""
LifetimeActivitiesExpert - Physical_Education Lifetime_Activities Expert
...
class LifetimeActivitiesExpert(BaseTutorAgent):
    """Expert for Lifetime Activities"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_high_school_lifetime_activities_experts_001",
