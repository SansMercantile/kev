"""
PersonalFitnessMentor - Physical_Education Personal_Fitness Mentor
...
class PersonalFitnessMentor(BaseTutorAgent):
    """Mentor for Personal Fitness"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_high_school_personal_fitness_mentors_001",
