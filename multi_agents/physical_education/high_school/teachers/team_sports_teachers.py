"""
TeamSportsTeacher - Physical_Education Team_Sports Teacher
...
class TeamSportsTeacher(BaseTutorAgent):
    """Teacher for Team Sports"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_high_school_team_sports_teachers_001",
