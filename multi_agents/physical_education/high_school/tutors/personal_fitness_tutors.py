"""
PersonalFitnessTutor - Physical_Education Personal_Fitness Tutor
...
class PersonalFitnessTutor(BaseTutorAgent):
    """Tutor for Personal Fitness"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_high_school_personal_fitness_tutors_001",
