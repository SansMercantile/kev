"""
HealthEducationTutor - Physical_Education Health_Education Tutor
...
class HealthEducationTutor(BaseTutorAgent):
    """Tutor for Health Education"""
    
    def __init__(self):
        super().__init__(
            tutor_id="physical_education_high_school_health_education_tutors_001",
