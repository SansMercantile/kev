...
Module: education_persona_agent
...
class EducationPersonaAgent(RobustAgent):
    """
    ...
    def __init__(self, **kwargs):
        """Initialize the EducationPersonaAgent with specialized capabilities."""
        super().__init__(
            agent_id="EDUCATION_PERSONA",
        ...
        logger.info(f"Initialized {self.agent_id} - EducationPersonaAgent for Persona Management")
