...
Module: education_consensus_agent
...
class EducationConsensusAgent(RobustAgent):
    """
    ...
    def __init__(self, **kwargs):
        """Initialize the EducationConsensusAgent with specialized capabilities."""
        super().__init__(
            agent_id="EDUCATION_CONSENSUS",
        ...
        logger.info(f"Initialized {self.agent_id} - EducationConsensusAgent for Consensus Building")
