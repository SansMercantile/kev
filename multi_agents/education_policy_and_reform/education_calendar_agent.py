...
Module: education_calendar_agent
...
class EducationCalendarAgent(RobustAgent):
    """
    ...
    def __init__(self, **kwargs):
        """Initialize the EducationCalendarAgent with specialized capabilities."""
        super().__init__(
            agent_id="EDUCATION_CALENDAR",
        ...
        logger.info(f"Initialized {self.agent_id} - EducationCalendarAgent for Calendar Management")
