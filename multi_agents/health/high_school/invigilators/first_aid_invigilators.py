"""
FirstAidInvigilator - Health First_Aid Invigilator
...
class FirstAidInvigilator(BaseTutorAgent):
    """Invigilator for First Aid"""
    
    def __init__(self):
        super().__init__(
            tutor_id="health_high_school_first_aid_invigilators_001",
            subject="Health",
