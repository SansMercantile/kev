"""
DesignPrinciplesMentor - Arts Design_Principles Mentor
...
class DesignPrinciplesMentor(BaseTutorAgent):
    """Mentor for Design Principles"""
    
    def __init__(self):
        super().__init__(
            tutor_id="arts_middle_school_design_principles_mentors_001",
            subject="Arts",
