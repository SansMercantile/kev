"""
ArtHistoryExpert - Arts Art_History Expert
...
class ArtHistoryExpert(BaseTutorAgent):
    """Expert for Art History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="arts_middle_school_art_history_experts_001",
            subject="Arts",
