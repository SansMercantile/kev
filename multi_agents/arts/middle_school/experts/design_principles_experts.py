"""
DesignPrinciplesExpert - Arts Design_Principles Expert
...
class DesignPrinciplesExpert(BaseTutorAgent):
    """Expert for Design Principles"""
    
    def __init__(self):
        super().__init__(
            tutor_id="arts_middle_school_design_principles_experts_001",
            subject="Arts",
