"""
DesignPrinciplesInvigilator - Arts Design_Principles Invigilator
...
class DesignPrinciplesInvigilator(BaseTutorAgent):
    """Invigilator for Design Principles"""
    
    def __init__(self):
        super().__init__(
            tutor_id="arts_middle_school_design_principles_invigilators_001",
            subject="Arts",
