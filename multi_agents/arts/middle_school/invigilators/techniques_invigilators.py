"""
TechniquesInvigilator - Arts Techniques Invigilator
...
class TechniquesInvigilator(BaseTutorAgent):
    """Invigilator for Techniques"""
    
    def __init__(self):
        super().__init__(
            tutor_id="arts_middle_school_techniques_invigilators_001",
            subject="Arts",
