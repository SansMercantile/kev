"""
DrawingInvigilator - Arts Drawing Invigilator
...
class DrawingInvigilator(BaseTutorAgent):
    """Invigilator for Drawing"""
    
    def __init__(self):
        super().__init__(
            tutor_id="arts_elementary_drawing_invigilators_001",
            subject="Arts",
