"""
SculptureInvigilator - Arts Sculpture Invigilator
...
class SculptureInvigilator(BaseTutorAgent):
    """Invigilator for Sculpture"""
    
    def __init__(self):
        super().__init__(
            tutor_id="arts_elementary_sculpture_invigilators_001",
            subject="Arts",
