"""
DigitalArtInvigilator - Arts Digital_Art Invigilator
...
class DigitalArtInvigilator(BaseTutorAgent):
    """Invigilator for Digital Art"""
    
    def __init__(self):
        super().__init__(
            tutor_id="arts_high_school_digital_art_invigilators_001",
            subject="Arts",
