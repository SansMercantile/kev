"""
GraphicDesignMentor - Arts Graphic_Design Mentor
...
class GraphicDesignMentor(BaseTutorAgent):
    """Mentor for Graphic Design"""
    
    def __init__(self):
        super().__init__(
            tutor_id="arts_high_school_graphic_design_mentors_001",
            subject="Arts",
