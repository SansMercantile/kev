"""
PsychologyMentor - Social_Studies Psychology Mentor
...
class PsychologyMentor(BaseTutorAgent):
    """Mentor for Psychology"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_high_school_psychology_mentors_001",
