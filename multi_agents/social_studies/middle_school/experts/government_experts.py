"""
GovernmentExpert - Social_Studies Government Expert
...
class GovernmentExpert(BaseTutorAgent):
    """Expert for Government"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_middle_school_government_experts_001",
