"""
WorldHistoryExpert - Social_Studies World_History Expert
...
class WorldHistoryExpert(BaseTutorAgent):
    """Expert for World History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_middle_school_world_history_experts_001",
