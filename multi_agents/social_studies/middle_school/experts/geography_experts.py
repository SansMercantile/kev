"""
GeographyExpert - Social_Studies Geography Expert
...
class GeographyExpert(BaseTutorAgent):
    """Expert for Geography"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_middle_school_geography_experts_001",
