"""
GeographyTeacher - Social_Studies Geography Teacher
...
class GeographyTeacher(BaseTutorAgent):
    """Teacher for Geography"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_middle_school_geography_teachers_001",
