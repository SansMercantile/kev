"""
WorldHistoryInvigilator - Social_Studies World_History Invigilator
...
class WorldHistoryInvigilator(BaseTutorAgent):
    """Invigilator for World History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_middle_school_world_history_invigilators_001",
