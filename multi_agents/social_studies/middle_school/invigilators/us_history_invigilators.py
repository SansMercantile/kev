"""
UsHistoryInvigilator - Social_Studies Us_History Invigilator
...
class UsHistoryInvigilator(BaseTutorAgent):
    """Invigilator for Us History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_middle_school_us_history_invigilators_001",
