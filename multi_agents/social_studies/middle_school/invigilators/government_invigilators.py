"""
GovernmentInvigilator - Social_Studies Government Invigilator
...
class GovernmentInvigilator(BaseTutorAgent):
    """Invigilator for Government"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_middle_school_government_invigilators_001",
