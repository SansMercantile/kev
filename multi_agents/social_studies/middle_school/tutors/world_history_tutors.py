"""
WorldHistoryTutor - Social_Studies World_History Tutor
...
class WorldHistoryTutor(BaseTutorAgent):
    """Tutor for World History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_middle_school_world_history_tutors_001",
