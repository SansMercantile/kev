"""
UsHistoryTutor - Social_Studies Us_History Tutor
...
class UsHistoryTutor(BaseTutorAgent):
    """Tutor for Us History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_middle_school_us_history_tutors_001",
