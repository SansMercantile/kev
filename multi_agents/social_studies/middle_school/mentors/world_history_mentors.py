"""
WorldHistoryMentor - Social_Studies World_History Mentor
...
class WorldHistoryMentor(BaseTutorAgent):
    """Mentor for World History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_middle_school_world_history_mentors_001",
