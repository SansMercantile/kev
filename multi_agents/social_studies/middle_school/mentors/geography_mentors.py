"""
GeographyMentor - Social_Studies Geography Mentor
...
class GeographyMentor(BaseTutorAgent):
    """Mentor for Geography"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_middle_school_geography_mentors_001",
