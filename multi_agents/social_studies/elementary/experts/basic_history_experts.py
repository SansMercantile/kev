"""
BasicHistoryExpert - Social_Studies Basic_History Expert
...
class BasicHistoryExpert(BaseTutorAgent):
    """Expert for Basic History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_elementary_basic_history_experts_001",
