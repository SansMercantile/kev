"""
CivicsInvigilator - Social_Studies Civics Invigilator
...
class CivicsInvigilator(BaseTutorAgent):
    """Invigilator for Civics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_elementary_civics_invigilators_001",
