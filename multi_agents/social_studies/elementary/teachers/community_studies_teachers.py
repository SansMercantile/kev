"""
CommunityStudiesTeacher - Social_Studies Community_Studies Teacher
...
class CommunityStudiesTeacher(BaseTutorAgent):
    """Teacher for Community Studies"""
    
    def __init__(self):
        super().__init__(
            tutor_id="social_studies_elementary_community_studies_teachers_001",
