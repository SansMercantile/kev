"""
WebDevelopmentMentor - Computer_Science Web_Development Mentor
...
class WebDevelopmentMentor(BaseTutorAgent):
    """Mentor for Web Development"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_high_school_web_development_mentors_001",
