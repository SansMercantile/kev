"""
PythonInvigilator - Computer_Science Python Invigilator
...
class PythonInvigilator(BaseTutorAgent):
    """Invigilator for Python"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_high_school_python_invigilators_001",
