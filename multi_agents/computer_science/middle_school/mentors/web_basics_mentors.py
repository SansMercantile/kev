"""
WebBasicsMentor - Computer_Science Web_Basics Mentor
...
class WebBasicsMentor(BaseTutorAgent):
    """Mentor for Web Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_middle_school_web_basics_mentors_001",
