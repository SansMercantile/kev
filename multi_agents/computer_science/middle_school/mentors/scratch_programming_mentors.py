"""
ScratchProgrammingMentor - Computer_Science Scratch_Programming Mentor
...
class ScratchProgrammingMentor(BaseTutorAgent):
    """Mentor for Scratch Programming"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_middle_school_scratch_programming_mentors_001",
