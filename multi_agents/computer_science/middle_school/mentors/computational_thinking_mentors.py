"""
ComputationalThinkingMentor - Computer_Science Computational_Thinking Mentor
...
class ComputationalThinkingMentor(BaseTutorAgent):
    """Mentor for Computational Thinking"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_middle_school_computational_thinking_mentors_001",
