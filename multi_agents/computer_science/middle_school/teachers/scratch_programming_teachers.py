"""
ScratchProgrammingTeacher - Computer_Science Scratch_Programming Teacher
...
class ScratchProgrammingTeacher(BaseTutorAgent):
    """Teacher for Scratch Programming"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_middle_school_scratch_programming_teachers_001",
