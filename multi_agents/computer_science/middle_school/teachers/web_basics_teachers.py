"""
WebBasicsTeacher - Computer_Science Web_Basics Teacher
...
class WebBasicsTeacher(BaseTutorAgent):
    """Teacher for Web Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_middle_school_web_basics_teachers_001",
