"""
ComputationalThinkingTutor - Computer_Science Computational_Thinking Tutor
...
class ComputationalThinkingTutor(BaseTutorAgent):
    """Tutor for Computational Thinking"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_middle_school_computational_thinking_tutors_001",
