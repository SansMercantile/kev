"""
ScratchProgrammingTutor - Computer_Science Scratch_Programming Tutor
...
class ScratchProgrammingTutor(BaseTutorAgent):
    """Tutor for Scratch Programming"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_middle_school_scratch_programming_tutors_001",
