"""
ScratchProgrammingExpert - Computer_Science Scratch_Programming Expert
...
class ScratchProgrammingExpert(BaseTutorAgent):
    """Expert for Scratch Programming"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_middle_school_scratch_programming_experts_001",
