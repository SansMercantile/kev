"""
WebBasicsExpert - Computer_Science Web_Basics Expert
...
class WebBasicsExpert(BaseTutorAgent):
    """Expert for Web Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_middle_school_web_basics_experts_001",
