"""
ComputationalThinkingExpert - Computer_Science Computational_Thinking Expert
...
class ComputationalThinkingExpert(BaseTutorAgent):
    """Expert for Computational Thinking"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_middle_school_computational_thinking_experts_001",
