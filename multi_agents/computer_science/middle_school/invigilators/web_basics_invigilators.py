"""
WebBasicsInvigilator - Computer_Science Web_Basics Invigilator
...
class WebBasicsInvigilator(BaseTutorAgent):
    """Invigilator for Web Basics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="computer_science_middle_school_web_basics_invigilators_001",
