...
Module: education_automation_agent
...
class EducationAutomationAgent(RobustAgent):
    """
    ...
    def __init__(self, **kwargs):
        """Initialize the EducationAutomationAgent with specialized capabilities."""
        super().__init__(
            agent_id="EDUCATION_AUTOMATION",
        ...
        logger.info(f"Initialized {self.agent_id} - EducationAutomationAgent for Automation")
