...
class EducationEventAgent(RobustAgent):
    """
    ...
    def __init__(self, **kwargs):
        """Initialize the EducationEventAgent with specialized capabilities."""
        super().__init__(
            agent_id="EDUCATION_EVENT",
        ...
        logger.info(f"Initialized {self.agent_id} - EducationEventAgent for Event Management")
