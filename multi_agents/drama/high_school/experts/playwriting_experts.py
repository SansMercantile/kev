"""
PlaywritingExpert - Drama Playwriting Expert
...
class PlaywritingExpert(BaseTutorAgent):
    """Expert for Playwriting"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_playwriting_experts_001",
            subject="Drama",
