"""
AdvancedActingExpert - Drama Advanced_Acting Expert
...
class AdvancedActingExpert(BaseTutorAgent):
    """Expert for Advanced Acting"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_advanced_acting_experts_001",
            subject="Drama",
