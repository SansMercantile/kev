"""
TheaterProductionExpert - Drama Theater_Production Expert
...
class TheaterProductionExpert(BaseTutorAgent):
    """Expert for Theater Production"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_theater_production_experts_001",
            subject="Drama",
