"""
TheaterProductionInvigilator - Drama Theater_Production Invigilator
...
class TheaterProductionInvigilator(BaseTutorAgent):
    """Invigilator for Theater Production"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_theater_production_invigilators_001",
            subject="Drama",
