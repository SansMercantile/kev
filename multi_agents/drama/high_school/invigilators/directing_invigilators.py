"""
DirectingInvigilator - Drama Directing Invigilator
...
class DirectingInvigilator(BaseTutorAgent):
    """Invigilator for Directing"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_directing_invigilators_001",
            subject="Drama",
