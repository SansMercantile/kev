"""
PlaywritingInvigilator - Drama Playwriting Invigilator
...
class PlaywritingInvigilator(BaseTutorAgent):
    """Invigilator for Playwriting"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_playwriting_invigilators_001",
            subject="Drama",
