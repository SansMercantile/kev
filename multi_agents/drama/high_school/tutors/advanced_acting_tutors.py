"""
AdvancedActingTutor - Drama Advanced_Acting Tutor
...
class AdvancedActingTutor(BaseTutorAgent):
    """Tutor for Advanced Acting"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_advanced_acting_tutors_001",
            subject="Drama",
