"""
TheaterProductionTutor - Drama Theater_Production Tutor
...
class TheaterProductionTutor(BaseTutorAgent):
    """Tutor for Theater Production"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_theater_production_tutors_001",
            subject="Drama",
