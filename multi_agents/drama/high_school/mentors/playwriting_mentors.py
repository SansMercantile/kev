"""
PlaywritingMentor - Drama Playwriting Mentor
...
class PlaywritingMentor(BaseTutorAgent):
    """Mentor for Playwriting"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_playwriting_mentors_001",
            subject="Drama",
