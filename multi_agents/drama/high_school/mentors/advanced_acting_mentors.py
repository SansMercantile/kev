"""
AdvancedActingMentor - Drama Advanced_Acting Mentor
...
class AdvancedActingMentor(BaseTutorAgent):
    """Mentor for Advanced Acting"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_advanced_acting_mentors_001",
            subject="Drama",
