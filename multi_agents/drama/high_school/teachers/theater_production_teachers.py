"""
TheaterProductionTeacher - Drama Theater_Production Teacher
...
class TheaterProductionTeacher(BaseTutorAgent):
    """Teacher for Theater Production"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_theater_production_teachers_001",
            subject="Drama",
