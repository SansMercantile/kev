"""
PlaywritingTeacher - Drama Playwriting Teacher
...
class PlaywritingTeacher(BaseTutorAgent):
    """Teacher for Playwriting"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_playwriting_teachers_001",
            subject="Drama",
