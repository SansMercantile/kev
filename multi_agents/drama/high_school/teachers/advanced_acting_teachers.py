"""
AdvancedActingTeacher - Drama Advanced_Acting Teacher
...
class AdvancedActingTeacher(BaseTutorAgent):
    """Teacher for Advanced Acting"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_high_school_advanced_acting_teachers_001",
            subject="Drama",
