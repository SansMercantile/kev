"""
StorytellingInvigilator - Drama Storytelling Invigilator
...
class StorytellingInvigilator(BaseTutorAgent):
    """Invigilator for Storytelling"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_elementary_storytelling_invigilators_001",
            subject="Drama",
