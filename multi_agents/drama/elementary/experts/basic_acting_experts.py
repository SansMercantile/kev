"""
BasicActingExpert - Drama Basic_Acting Expert
...
class BasicActingExpert(BaseTutorAgent):
    """Expert for Basic Acting"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_elementary_basic_acting_experts_001",
            subject="Drama",
