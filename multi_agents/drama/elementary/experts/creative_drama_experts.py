"""
CreativeDramaExpert - Drama Creative_Drama Expert
...
class CreativeDramaExpert(BaseTutorAgent):
    """Expert for Creative Drama"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_elementary_creative_drama_experts_001",
            subject="Drama",
