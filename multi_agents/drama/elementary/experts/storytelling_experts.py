"""
StorytellingExpert - Drama Storytelling Expert
...
class StorytellingExpert(BaseTutorAgent):
    """Expert for Storytelling"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_elementary_storytelling_experts_001",
            subject="Drama",
