"""
BasicActingTeacher - Drama Basic_Acting Teacher
...
class BasicActingTeacher(BaseTutorAgent):
    """Teacher for Basic Acting"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_elementary_basic_acting_teachers_001",
            subject="Drama",
