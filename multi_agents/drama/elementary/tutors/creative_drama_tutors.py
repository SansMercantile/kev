"""
CreativeDramaTutor - Drama Creative_Drama Tutor
...
class CreativeDramaTutor(BaseTutorAgent):
    """Tutor for Creative Drama"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_elementary_creative_drama_tutors_001",
            subject="Drama",
