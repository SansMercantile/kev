"""
StorytellingTutor - Drama Storytelling Tutor
...
class StorytellingTutor(BaseTutorAgent):
    """Tutor for Storytelling"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_elementary_storytelling_tutors_001",
            subject="Drama",
