"""
StorytellingMentor - Drama Storytelling Mentor
...
class StorytellingMentor(BaseTutorAgent):
    """Mentor for Storytelling"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_elementary_storytelling_mentors_001",
            subject="Drama",
