"""
BasicActingMentor - Drama Basic_Acting Mentor
...
class BasicActingMentor(BaseTutorAgent):
    """Mentor for Basic Acting"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_elementary_basic_acting_mentors_001",
            subject="Drama",
