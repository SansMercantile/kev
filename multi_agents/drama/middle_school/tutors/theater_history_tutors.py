"""
TheaterHistoryTutor - Drama Theater_History Tutor
...
class TheaterHistoryTutor(BaseTutorAgent):
    """Tutor for Theater History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_middle_school_theater_history_tutors_001",
            subject="Drama",
