"""
ActingTechniquesTutor - Drama Acting_Techniques Tutor
...
class ActingTechniquesTutor(BaseTutorAgent):
    """Tutor for Acting Techniques"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_middle_school_acting_techniques_tutors_001",
            subject="Drama",
