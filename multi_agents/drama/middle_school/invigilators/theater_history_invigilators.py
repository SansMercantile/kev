"""
TheaterHistoryInvigilator - Drama Theater_History Invigilator
...
class TheaterHistoryInvigilator(BaseTutorAgent):
    """Invigilator for Theater History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_middle_school_theater_history_invigilators_001",
            subject="Drama",
