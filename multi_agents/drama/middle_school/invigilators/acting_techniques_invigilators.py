"""
ActingTechniquesInvigilator - Drama Acting_Techniques Invigilator
...
class ActingTechniquesInvigilator(BaseTutorAgent):
    """Invigilator for Acting Techniques"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_middle_school_acting_techniques_invigilators_001",
            subject="Drama",
