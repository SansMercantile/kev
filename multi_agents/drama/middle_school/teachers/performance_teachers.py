"""
PerformanceTeacher - Drama Performance Teacher
...
class PerformanceTeacher(BaseTutorAgent):
    """Teacher for Performance"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_middle_school_performance_teachers_001",
            subject="Drama",
