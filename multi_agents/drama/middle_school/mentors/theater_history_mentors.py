"""
TheaterHistoryMentor - Drama Theater_History Mentor
...
class TheaterHistoryMentor(BaseTutorAgent):
    """Mentor for Theater History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_middle_school_theater_history_mentors_001",
            subject="Drama",
