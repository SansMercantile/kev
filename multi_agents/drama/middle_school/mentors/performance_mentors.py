"""
PerformanceMentor - Drama Performance Mentor
...
class PerformanceMentor(BaseTutorAgent):
    """Mentor for Performance"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_middle_school_performance_mentors_001",
            subject="Drama",
