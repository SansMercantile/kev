"""
ActingTechniquesMentor - Drama Acting_Techniques Mentor
...
class ActingTechniquesMentor(BaseTutorAgent):
    """Mentor for Acting Techniques"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_middle_school_acting_techniques_mentors_001",
            subject="Drama",
