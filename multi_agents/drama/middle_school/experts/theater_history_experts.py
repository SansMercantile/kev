"""
TheaterHistoryExpert - Drama Theater_History Expert
...
class TheaterHistoryExpert(BaseTutorAgent):
    """Expert for Theater History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="drama_middle_school_theater_history_experts_001",
            subject="Drama",
