"""
MusicAppreciationTutor - Music Music_Appreciation Tutor
...
class MusicAppreciationTutor(BaseTutorAgent):
    """Tutor for Music Appreciation"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_elementary_music_appreciation_tutors_001",
            subject="Music",
