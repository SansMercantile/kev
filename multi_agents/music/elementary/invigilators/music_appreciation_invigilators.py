"""
MusicAppreciationInvigilator - Music Music_Appreciation Invigilator
...
class MusicAppreciationInvigilator(BaseTutorAgent):
    """Invigilator for Music Appreciation"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_elementary_music_appreciation_invigilators_001",
            subject="Music",
