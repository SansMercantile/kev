"""
InstrumentalMusicInvigilator - Music Instrumental_Music Invigilator
...
class InstrumentalMusicInvigilator(BaseTutorAgent):
    """Invigilator for Instrumental Music"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_elementary_instrumental_music_invigilators_001",
            subject="Music",
