"""
InstrumentalMusicTeacher - Music Instrumental_Music Teacher
...
class InstrumentalMusicTeacher(BaseTutorAgent):
    """Teacher for Instrumental Music"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_elementary_instrumental_music_teachers_001",
            subject="Music",
