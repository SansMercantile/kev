"""
VocalMusicTeacher - Music Vocal_Music Teacher
...
class VocalMusicTeacher(BaseTutorAgent):
    """Teacher for Vocal Music"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_elementary_vocal_music_teachers_001",
            subject="Music",
