"""
MusicAppreciationTeacher - Music Music_Appreciation Teacher
...
class MusicAppreciationTeacher(BaseTutorAgent):
    """Teacher for Music Appreciation"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_elementary_music_appreciation_teachers_001",
            subject="Music",
