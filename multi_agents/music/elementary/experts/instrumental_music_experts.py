"""
InstrumentalMusicExpert - Music Instrumental_Music Expert
...
class InstrumentalMusicExpert(BaseTutorAgent):
    """Expert for Instrumental Music"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_elementary_instrumental_music_experts_001",
            subject="Music",
