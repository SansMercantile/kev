"""
MusicAppreciationMentor - Music Music_Appreciation Mentor
...
class MusicAppreciationMentor(BaseTutorAgent):
    """Mentor for Music Appreciation"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_elementary_music_appreciation_mentors_001",
            subject="Music",
