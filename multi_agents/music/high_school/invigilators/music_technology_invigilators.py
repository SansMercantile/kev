"""
MusicTechnologyInvigilator - Music Music_Technology Invigilator
...
class MusicTechnologyInvigilator(BaseTutorAgent):
    """Invigilator for Music Technology"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_music_technology_invigilators_001",
            subject="Music",
