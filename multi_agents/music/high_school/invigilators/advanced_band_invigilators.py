"""
AdvancedBandInvigilator - Music Advanced_Band Invigilator
...
class AdvancedBandInvigilator(BaseTutorAgent):
    """Invigilator for Advanced Band"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_advanced_band_invigilators_001",
            subject="Music",
