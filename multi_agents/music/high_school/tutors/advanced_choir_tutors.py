"""
AdvancedChoirTutor - Music Advanced_Choir Tutor
...
class AdvancedChoirTutor(BaseTutorAgent):
    """Tutor for Advanced Choir"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_advanced_choir_tutors_001",
            subject="Music",
