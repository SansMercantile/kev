"""
AdvancedBandExpert - Music Advanced_Band Expert
...
class AdvancedBandExpert(BaseTutorAgent):
    """Expert for Advanced Band"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_advanced_band_experts_001",
            subject="Music",
