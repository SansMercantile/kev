"""
AdvancedChoirExpert - Music Advanced_Choir Expert
...
class AdvancedChoirExpert(BaseTutorAgent):
    """Expert for Advanced Choir"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_advanced_choir_experts_001",
            subject="Music",
