"""
MusicTechnologyExpert - Music Music_Technology Expert
...
class MusicTechnologyExpert(BaseTutorAgent):
    """Expert for Music Technology"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_music_technology_experts_001",
            subject="Music",
