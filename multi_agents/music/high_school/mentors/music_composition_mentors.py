"""
MusicCompositionMentor - Music Music_Composition Mentor
...
class MusicCompositionMentor(BaseTutorAgent):
    """Mentor for Music Composition"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_music_composition_mentors_001",
            subject="Music",
