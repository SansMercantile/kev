"""
MusicTechnologyMentor - Music Music_Technology Mentor
...
class MusicTechnologyMentor(BaseTutorAgent):
    """Mentor for Music Technology"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_music_technology_mentors_001",
            subject="Music",
