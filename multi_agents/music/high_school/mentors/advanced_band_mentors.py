"""
AdvancedBandMentor - Music Advanced_Band Mentor
...
class AdvancedBandMentor(BaseTutorAgent):
    """Mentor for Advanced Band"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_advanced_band_mentors_001",
            subject="Music",
