"""
MusicCompositionTeacher - Music Music_Composition Teacher
...
class MusicCompositionTeacher(BaseTutorAgent):
    """Teacher for Music Composition"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_music_composition_teachers_001",
            subject="Music",
