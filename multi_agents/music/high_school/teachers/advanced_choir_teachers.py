"""
AdvancedChoirTeacher - Music Advanced_Choir Teacher
...
class AdvancedChoirTeacher(BaseTutorAgent):
    """Teacher for Advanced Choir"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_advanced_choir_teachers_001",
            subject="Music",
