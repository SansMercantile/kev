"""
AdvancedBandTeacher - Music Advanced_Band Teacher
...
class AdvancedBandTeacher(BaseTutorAgent):
    """Teacher for Advanced Band"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_advanced_band_teachers_001",
            subject="Music",
