"""
MusicTechnologyTeacher - Music Music_Technology Teacher
...
class MusicTechnologyTeacher(BaseTutorAgent):
    """Teacher for Music Technology"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_high_school_music_technology_teachers_001",
            subject="Music",
