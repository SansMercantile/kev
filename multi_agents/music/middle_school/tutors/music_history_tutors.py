"""
MusicHistoryTutor - Music Music_History Tutor
...
class MusicHistoryTutor(BaseTutorAgent):
    """Tutor for Music History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_middle_school_music_history_tutors_001",
            subject="Music",
