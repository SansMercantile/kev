"""
MusicHistoryExpert - Music Music_History Expert
...
class MusicHistoryExpert(BaseTutorAgent):
    """Expert for Music History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_middle_school_music_history_experts_001",
            subject="Music",
