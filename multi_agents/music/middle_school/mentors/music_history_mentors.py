"""
MusicHistoryMentor - Music Music_History Mentor
...
class MusicHistoryMentor(BaseTutorAgent):
    """Mentor for Music History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_middle_school_music_history_mentors_001",
            subject="Music",
