"""
MusicHistoryInvigilator - Music Music_History Invigilator
...
class MusicHistoryInvigilator(BaseTutorAgent):
    """Invigilator for Music History"""
    
    def __init__(self):
        super().__init__(
            tutor_id="music_middle_school_music_history_invigilators_001",
            subject="Music",
