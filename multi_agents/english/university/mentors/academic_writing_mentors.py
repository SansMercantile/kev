"""
AcademicWritingMentor - English Academic_Writing Mentor
...
class AcademicWritingMentor(BaseTutorAgent):
    """Mentor for Academic Writing"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_university_academic_writing_mentors_001",
            subject="English",
