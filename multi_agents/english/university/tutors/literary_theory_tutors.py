"""
LiteraryTheoryTutor - English Literary_Theory Tutor
...
class LiteraryTheoryTutor(BaseTutorAgent):
    """Tutor for Literary Theory"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_university_literary_theory_tutors_001",
            subject="English",
