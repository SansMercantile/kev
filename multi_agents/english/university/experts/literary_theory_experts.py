"""
LiteraryTheoryExpert - English Literary_Theory Expert
...
class LiteraryTheoryExpert(BaseTutorAgent):
    """Expert for Literary Theory"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_university_literary_theory_experts_001",
            subject="English",
