"""
AcademicWritingInvigilator - English Academic_Writing Invigilator
...
class AcademicWritingInvigilator(BaseTutorAgent):
    """Invigilator for Academic Writing"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_university_academic_writing_invigilators_001",
            subject="English",
