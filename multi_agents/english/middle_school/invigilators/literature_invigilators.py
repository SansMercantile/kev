"""
LiteratureInvigilator - English Literature Invigilator
...
class LiteratureInvigilator(BaseTutorAgent):
    """Invigilator for Literature"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_middle_school_literature_invigilators_001",
            subject="English",
