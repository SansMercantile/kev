"""
GrammarInvigilator - English Grammar Invigilator
...
class GrammarInvigilator(BaseTutorAgent):
    """Invigilator for Grammar"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_middle_school_grammar_invigilators_001",
            subject="English",
