"""
LiteratureTeacher - English Literature Teacher
...
class LiteratureTeacher(BaseTutorAgent):
    """Teacher for Literature"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_middle_school_literature_teachers_001",
            subject="English",
