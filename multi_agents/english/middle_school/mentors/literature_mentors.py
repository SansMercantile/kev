"""
LiteratureMentor - English Literature Mentor
...
class LiteratureMentor(BaseTutorAgent):
    """Mentor for Literature"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_middle_school_literature_mentors_001",
            subject="English",
