"""
CreativeWritingExpert - English Creative_Writing Expert
...
class CreativeWritingExpert(BaseTutorAgent):
    """Expert for Creative Writing"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_high_school_creative_writing_experts_001",
            subject="English",
