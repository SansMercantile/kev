"""
CreativeWritingMentor - English Creative_Writing Mentor
...
class CreativeWritingMentor(BaseTutorAgent):
    """Mentor for Creative Writing"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_high_school_creative_writing_mentors_001",
            subject="English",
