"""
CreativeWritingInvigilator - English Creative_Writing Invigilator
...
class CreativeWritingInvigilator(BaseTutorAgent):
    """Invigilator for Creative Writing"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_high_school_creative_writing_invigilators_001",
            subject="English",
