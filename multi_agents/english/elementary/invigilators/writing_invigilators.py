"""
WritingInvigilator - English Writing Invigilator
...
class WritingInvigilator(BaseTutorAgent):
    """Invigilator for Writing"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_elementary_writing_invigilators_001",
            subject="English",
