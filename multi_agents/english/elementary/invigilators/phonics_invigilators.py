"""
PhonicsInvigilator - English Phonics Invigilator
...
class PhonicsInvigilator(BaseTutorAgent):
    """Invigilator for Phonics"""
    
    def __init__(self):
        super().__init__(
            tutor_id="english_elementary_phonics_invigilators_001",
            subject="English",
